declare const ErrorForConvert: {
    enum: {};
    index: readonly ("Country of operations cannot be empty" | "Company name cannot be empty" | "Payment mode cannot be empty" | "Product service complexity cannot be empty" | "Ownership structure layer cannot be empty" | "Onboarding mode cannot be empty" | "Entity type cannot be empty" | "Industry code cannot be empty")[];
} & {
    enum: {
        "Country of operations cannot be empty": "Country of operations cannot be empty" | "Company name cannot be empty" | "Payment mode cannot be empty" | "Product service complexity cannot be empty" | "Ownership structure layer cannot be empty" | "Onboarding mode cannot be empty" | "Entity type cannot be empty" | "Industry code cannot be empty";
        "Company name cannot be empty": "Country of operations cannot be empty" | "Company name cannot be empty" | "Payment mode cannot be empty" | "Product service complexity cannot be empty" | "Ownership structure layer cannot be empty" | "Onboarding mode cannot be empty" | "Entity type cannot be empty" | "Industry code cannot be empty";
        "Payment mode cannot be empty": "Country of operations cannot be empty" | "Company name cannot be empty" | "Payment mode cannot be empty" | "Product service complexity cannot be empty" | "Ownership structure layer cannot be empty" | "Onboarding mode cannot be empty" | "Entity type cannot be empty" | "Industry code cannot be empty";
        ...
        "Entity type cannot be empty": "Country of operations cannot be empty" | "Company name cannot be empty" | "Payment mode cannot be empty" | "Product service complexity cannot be empty" | "Ownership structure layer cannot be empty" | "Onboarding mode cannot be empty" | "Entity type cannot be empty" | "Industry code cannot be empty";
        "Industry code cannot be empty": "Country of operations cannot be empty" | "Company name cannot be empty" | "Payment mode cannot be empty" | "Product service complexity cannot be empty" | "Ownership structure layer cannot be empty" | "Onboarding mode cannot be empty" | "Entity type cannot be empty" | "Industry code cannot be empty";
    };
    single: "Country of operations cannot be empty" | "Company name cannot be empty" | "Payment mode cannot be empty" | "Product service complexity cannot be empty" | "Ownership structure layer cannot be empty" | "Onboarding mode cannot be empty" | "Entity type cannot be empty" | "Industry code cannot be empty";
};
